...
public final class DialogAddCourseBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnSubmitCourse;
  ...
  private DialogAddCourseBinding(@NonNull LinearLayout rootView, @NonNull Button btnSubmitCourse,
      @NonNull EditText etCourseName, @NonNull TextView tvDialogTitle) {
    this.rootView = rootView;
    this.btnSubmitCourse = btnSubmitCourse;
  ...
  public static DialogAddCourseBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btnSubmitCourse;
      Button btnSubmitCourse = ViewBindings.findChildViewById(rootView, id);
      if (btnSubmitCourse == null) {
        break missingId;
      }
      ...
      return new DialogAddCourseBinding((LinearLayout) rootView, btnSubmitCourse, etCourseName,
          tvDialogTitle);
    }
