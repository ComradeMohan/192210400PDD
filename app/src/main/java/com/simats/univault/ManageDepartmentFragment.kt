...
// Set layout animation for department list
    ...
    private fun fetchDepartments(collegeId: String) {
        val url = "http://10.235.18.54/univault/get_departments.php?college_id=$collegeId"
    ...
    private fun addDepartment(name: String) {
        val url = "http://10.235.18.54/univault/add_department.php"
        val queue = Volley.newRequestQueue(requireContext())
    ...
    private fun deleteDepartment(deptId: String) {
        val url = "http://10.235.18.54/univault/delete_department.php"
        val queue = Volley.newRequestQueue(requireContext())
