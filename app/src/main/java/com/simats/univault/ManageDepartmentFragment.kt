...
// Set layout animation for department list
    ...
    private fun fetchDepartments(collegeId: String) {
        val url = "http://10.169.48.54/univault/get_departments.php?college_id=$collegeId"
    ...
    private fun addDepartment(name: String) {
        val url = "http://10.169.48.54/univault/add_department.php"
        val queue = Volley.newRequestQueue(requireContext())
    ...
    private fun deleteDepartment(deptId: String) {
        val url = "http://10.169.48.54/univault/delete_department.php"
        val queue = Volley.newRequestQueue(requireContext())
    ...
    private fun deleteCourse(courseId: String) {
        val url = "http://10.169.48.54/univault/delete_course.php"
        val queue = Volley.newRequestQueue(requireContext())
    ...
    private fun fetchCourses(departmentId: String) {
        val url = "http://10.169.48.54/univault/get_courses.php?department_id=$departmentId"
        val queue = Volley.newRequestQueue(requireContext())
