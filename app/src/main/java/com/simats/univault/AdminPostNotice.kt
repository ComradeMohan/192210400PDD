...
class AdminPostNotice : AppCompatActivity() {
    ...
    private fun postNoticeToServer(
        ...
        val url = "http://10.235.18.54/univault/post_notice.php"
    ...
    private fun loadOldNotices(college: String) {
        val url = "http://10.235.18.54/univault/fetch_notifications.php?college_name=$college"
    ...
    private fun deleteNoticeFromServer(noticeTitle: String) {
        val url = "http://10.235.18.54/univault/delete_notice.php"
