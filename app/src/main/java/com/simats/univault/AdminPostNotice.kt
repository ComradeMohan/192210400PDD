...
class AdminPostNotice : AppCompatActivity() {
    ...
    private fun postNoticeToServer(
        ...
        val url = "http://192.168.56.1/univault/post_notice.php"
    ...
    private fun loadOldNotices(college: String) {
        val url = "http://192.168.56.1/univault/fetch_notifications.php?college_name=$college"
    ...
    private fun deleteNoticeFromServer(noticeTitle: String) {
        val url = "http://192.168.56.1/univault/delete_notice.php"
