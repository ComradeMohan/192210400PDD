...
class AcadmicRecordActivity : AppCompatActivity() {
    ...
    private fun fetchCollegeId(collegeName: String) {
        val url = "http://10.137.118.54/univault/get_college_id.php"
    ...
    private fun fetchDepartmentId(collegeId: String, departmentName: String) {
        val url = "http://10.137.118.54/univault/get_department_id.php"
    ...
    private fun fetchCourses(departmentId: String) {
        val url = "http://10.137.118.54/univault/get_courses_by_department.php"
    ...
    private fun fetchGradePoints(collegeId: String) {
        val url = "http://10.137.118.54/univault/get_grade_points.php?college_id=$collegeId"
    ...
    private fun fetchCompletedCourses(studentId: String, departmentId: String) {
        val url = "http://10.137.118.54/univault/student_grades_completed.php?student_id=$studentId&department_id=$departmentId"
