...
public final class ItemNoticeBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView btnDeleteNotice;
  ...
  private ItemNoticeBinding(@NonNull LinearLayout rootView, @NonNull ImageView btnDeleteNotice,
  ...
  public static ItemNoticeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView btnDeleteNotice = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemNoticeBinding((LinearLayout) rootView, btnDeleteNotice, tvNoticeDate,
