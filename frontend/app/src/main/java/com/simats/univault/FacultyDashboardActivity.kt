...
import com.simats.univault.databinding.ActivityFacultyDashboardBinding
...
class FacultyDashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set TabLayout selection listener
    ...
    override fun onBackPressed() {
        ...
        if (currentFragment !is FacultyHomeFragment) {
            ...
            // Select the Home tab (position 0)
    ...
    // Helper function to programmatically select a tab
    private fun selectTab(position: Int) {
        binding.tabLayout.selectTab(binding.tabLayout.getTabAt(position))
    }

    // Helper function to get current selected tab position
